...
$router->get('/utilisateurs', 'UserController@utilisateur');
...
$router->post('/utilisateurs/update', 'UserController@updateStudent');
$router->post('/utilisateurs/toggle', 'UserController@toggleStudent');
